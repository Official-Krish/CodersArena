const languages = [
    ...
    },
    {
      ...
      run_cmd:
        "SBCL_HOME=/usr/local/sbcl-2.0.0/lib/sbcl /usr/local/sbcl-2.0.0/bin/sbcl --script script.lisp",
    },
    {
      id: 56,
      name: "D (DMD 2.089.1)",
    ...
    },
    {
      ...
      source_file: "main.go",
      compile_cmd:
        "GOCACHE=/tmp/.cache/go-build /usr/local/go-1.13.5/bin/go build %s main.go",
      run_cmd: "./main",
    },
    {
      id: 61,
    ...
    },
    {
      ...
      run_cmd:
        "/usr/local/octave-5.1.0/bin/octave-cli -q --no-gui --no-history script.m",
    },
    {
      id: 67,
    ...
    },
    {
      ...
      compile_cmd:
        'PATH="/usr/local/gprolog-1.4.5/gprolog-1.4.5/bin:$PATH" /usr/local/gprolog-1.4.5/gprolog-1.4.5/bin/gplc --no-top-level %s main.pro',
      run_cmd: "./main",
    },
    {
      id: 70,
    ...
    },
    {
      ...
      source_file: "main.m",
      compile_cmd:
        "/usr/bin/clang-7 `gnustep-config --objc-flags | sed 's/-W[^ ]* //g'` `gnustep-config --base-libs | sed 's/-shared-libgcc//'` -I/usr/lib/gcc/x86_64-linux-gnu/8/include main.m %s",
      run_cmd: "./a.out",
    },
    {
      id: 80,
    ...
    },
    {
      ...
      run_cmd:
        "/usr/local/bin/java -jar /usr/local/clojure-1.10.1/clojure.jar main.clj",
    },
    {
      id: 87,
      ...
      run_cmd:
        "mkdir -p ~/.dotnet && touch ~/.dotnet/3.1.202.dotnetFirstUseSentinel && /usr/local/dotnet-sdk/dotnet fsi script.fsx",
    },
    {
      id: 88,
      name: "Groovy (3.0.3)",
